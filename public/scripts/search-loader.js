...
// This is an optimization script - if it fails, search will still work without highlighting
(function () {
  try {
    ...
    function loadSearchScripts() {
      ...
      return Promise.all([
        ...
        new Promise((resolve, reject) => {
          ...
          script1.src = '/scripts/search-highlighter.js';
        ...
        new Promise((resolve, reject) => {
          ...
          script2.src = '/scripts/search-click-handler.js';
    ...
    // Fail silently - search will work without lazy loading optimization
    console.debug('Search optimization script failed to load:', error);
  }
})();
