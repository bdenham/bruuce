...
There's a new kid on the block: <span className="text-yellow font-bold">Adobe's Edge Delivery Services!</span> My next project is recreating this site with Adobe's Edge Delivery Services architecture. Then the fight is on. Which will be faster?!?
